...
const dataSource = {
  ...
  Carousel: {
    ...
    children: [
      {
        title: { className: 'feature6-title-text', children: '服务客户' },
        ...
        children: [
          {
            ...
            children: { className: 'feature6-text', children: '先头企业' },
          },
          {
            md: 8,
            xs: 24,
            ...
            children: { className: 'feature6-text', children: '咨询诊断企业' },
          },
          {
            md: 8,
            xs: 24,
            ...
            children: { className: 'feature6-text', children: '工业联盟客户' },
          },
        ],
      },
      // {
